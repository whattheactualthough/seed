...
describe('createRefObject', () => {
  ...
  test('returns an object of 1 key-value pair representing article_title and article_id when passed an array of a single article object', () => {
    const input = [
    {
      article_id: 1,
    ...
    test('returns an object of multiple key-value pairs representing article_title and article_id when passed an array of a multiple article objects', ()=> {
      const input = [
        {
          article_id: 1,
          title: 'Living in the shadow of a great man',
