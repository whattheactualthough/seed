...
describe("DELETE /api/comments/:comment_id", () => {
  test("204: responds with no content", () => {
    return request(app)
      ...
      .then(() => {
        return db
          .query(`SELECT * FROM comments WHERE comment_id = 1000`)
          .then(({ rows }) => {
...
("POST: /api/articles", () => {
  test("200: responds with newly added article ", () => {
    const testArticle = {
      title: "finally posting an article",
      topic: "mitch",
      author: "butter_bridge",
      body: "testing testing",
      article_img_url: "aurl",
    };
    return request(app)
      .post("/api/articles")
      .send(testArticle)
  ...
  test("400: Invalid topic", () => {
    const testArticle = {
      title: "finally posting an article",
      topic: "this is not a valid topic",
      author: "butter_bridge",
      body: "testing testing",
      article_img_url: "aurl",
    };
  ...
  test("400: Invalid author", () => {
    const testArticle = {
      title: "this is an invalid author",
      topic: "mitch",
      author: "lululu",
      body: "testing testing",
      article_img_url: "aurl",
  ...
  test("400: responds with missing required fields when given an empty article object", () => {
    const testArticle = {};
    return request(app)
      .post("/api/articles")
      .send(testArticle)
  ...
  test("400: responds with missing required fields when required inputs are missing ", () => {
    const testArticle = {
  ...
  test("400: responds with missing required fields when foreign key inputs are missing ", () => {
    const testArticle = {
      title: "article with missing fields",
      topic: "mitch",
      article_img_url: "aurl",
  ...
  add default url if none given 
  invalid body / title input - !String
  */
});
