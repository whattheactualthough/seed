...
const { checkArticleExists, checkUserExists, fetchTopics } = require("./utils");
...
const updateArticleVotes = (article_id, inc_votes) => {
  ...
  return checkArticleExists(article_id_num).then(() => {
    return db
      .query(
        `UPDATE articles
        SET votes = votes + $1
